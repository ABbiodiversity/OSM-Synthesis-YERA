...
plot(as.matrix(brt[,2:8]), as.matrix(brt2[,2:8])) #Best and rand are very strongly correlated.
plot(as.matrix(brt[,9:14]), as.matrix(brt2[,9:14])) #Best and rand are very strongly correlated.
