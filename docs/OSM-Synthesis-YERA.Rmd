...
```
<br>
``` {r detection-full, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width="70%", fig.cap="Estimated Yellow Rail detection probability through the full study region."}
...
```
<br>
``` {r ec-full, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width="65%", fig.cap="Local Yellow Rail colonization and extinction probability for the full study region."}
...
<br>
``` {r occ-comb, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width="100%", fig.cap="Estimated Yellow Rail occupancy in four regional subsets."}
...
```{r occ-full, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width="65%", fig.cap="Estimated Yellow Rail occupancy for the full study region."}
...
sf_mine <- st_read("./data/base/spatial/mine-encroachment.shp") %>%
...
encroach <- ggplot(data = sf_sites) +
  geom_sf(aes(color = `Rail Detection`, fill = `Rail Detection`), size = 2) +
  geom_sf(data = sf_mine, fill = "grey80", color = "black") +
...
```{r mine-encroach, include=TRUE, echo=FALSE, message=FALSE, warning=FALSE, eval=TRUE, out.width="60%", fig.cap="Patterns of Yellow Rail presence in relation to mine footprint between 2013 and 2018."}
