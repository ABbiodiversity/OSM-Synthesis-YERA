...
include_graphics(here("results", c("WESTWaterDepthByYear.jpeg", "EASTWaterDepthByYear.jpeg")))
...
```{r mine-encroach, include=TRUE, echo=FALSE, warning=FALSE, message=FALSE, eval=TRUE, out.width="100%", fig.cap="Oil sands mine encroachment near McClelland Lake Fen from 2013-2018. Yellow Rail survey sites are represented by the points, and colored by whether a Rail was detected."}

include_graphics(here("./docs/pics/mine-encroach.png"))
